...
#at each string, nested loop to get contiguous substrings
# when building each substring, create set. if letter not in set, add. if it is, delete
#set should only have 1 value if string is 
